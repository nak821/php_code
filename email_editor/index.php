...
<html lang="en">
    <head>
        ...
        <![endif]-->
        <script type="text/javascript"> var path = '/demo';</script>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="left" class="title" style="padding:5px 50px 5px 50px">
                                                       ...
                                                       <h4 style="font-family:Arial">Your Subtitle</h4>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="center" style="padding:15px 50px 15px 50px;" class="image">
                                                            <a class="link" href="#" data-link=""><img class=""  border="0"  align="one_image" style="display:block;max-width:640px" alt="" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=350%C3%97150&w=350&h=150" tabindex="0"></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                        ...
                                                        <table class="image-in-table" width="190" align="left" style="padding:5px">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td width="160">
                                                                    <a class="link"> <img  border="0"  align="left" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=350%C3%97150&w=350&h=150" style="display: block;margin: 0px;max-width: 540px;padding:10px;"></a>                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <table class="image-in-table" width="190" align="left">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="gap" width="30"></td>
                                                                    <td width="160">
                                                                        <a class="link"><img   border="0"  align="left" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=350%C3%97150&w=350&h=150" style="display: block;margin: 0px;max-width: 340px"></a>                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
 ...
 <a class="link"><img  border="0"  align="left" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=350%C3%97150&w=350&h=150" style="display: block;margin: 0px;max-width: 340px"></a>                                                                    </td>
                  ...
                  <a class="link" ><img src="https://placeholdit.imgix.net/~text?txtsize=33&txt=350%C3%97150&w=350&h=150" alt="" style="display: block;" height="154" align="2" border="0" width="255"></a>                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td height="15" width="100%"></td>
                                                                                </tr>
                                                                    ...
                                                                    <td>
                                                                        <table class="image-caption-column" align="left" border="0" cellpadding="0" cellspacing="0" width="160">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="image-caption-content image" style="font-family: Arial; font-size: 13px; color: #000000;">
                                                                                                <a class="link"><img src="https://placeholdit.imgix.net/~text?txtsize=33&txt=350%C3%97150&w=350&h=150" alt="" style="display: block;" height="154" align="2" border="0" width="160"></a>
                                                                                     </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td height="15" width="100%"></td>
                                                ...
                                                <tr>
                                                    <td class="social" align="center" style="padding: 15px 50px 15px 50px;">
                                                        <a href="#" style="border: none;" class="facebook">
                                                            <img border="0" src="img/facebook.png" />

                                                        </a>
                                                        <a href="#" style="border: none;" class="twitter">

                                                            <img border="0" src="img/twitter.png"/>


                                                        </a>
                                                        <a href="#" style="border: none;" class="linkedin">

                                                            <img  border="0" src="img/linkedin.png"/>


                                                        </a>
                                                        <a href="#" style="border: none;" class="youtube">

                                                            <img border=0 src="img/youtube.png"/>
